    ...
    <div className="flex min-h-screen">
      ...
      <aside className="flex flex-col items-center w-64 min-h-screen bg-[#1a3353] py-8">
        ...
        <nav className="flex flex-col gap-6 w-full px-8">
          <Link to="/committee/dashboard" className="flex items-center text-gray-200 gap-3">
            <span className="text-xl">🏠</span>
            <span className="font-medium">Dashboard</span>
          </Link>
          <Link to="/committee/risk-heatmap" className="flex items-center text-gray-200 gap-3">
            <span className="text-xl">📊</span>
